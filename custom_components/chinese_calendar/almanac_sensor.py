...
class AlmanacDevice:
    ...
    async def async_setup(self,hass):
        ...
        yaml_path=os.path.join(os.path.dirname(os.path.dirname(os.path.abspath(__file__))),'chinese_calendar','hworkdays.yaml')
...
class AlmanacSensor(SensorEntity):
    ...
    def _convert_text(self, text):
        ...
        return text if language != "zh-Hant" else zhconv.convert(text, 'zh-hant')
